 ...
 * @Author 绝命三郎
 */
class BitmapClippingView @JvmOverloads constructor(
    context: Context?,
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        shadowPaint = Paint()
        shadowPaint!!.color = Color.parseColor("#57FF9800")
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (initTag) {
            ...
            if (bitmapWidth > bimapHeight) {
                //宽大于高，取高
                val checkboxHeight = backgroundImgHeight //选框的高
                val checkboxWidth = ((checkboxHeight / proportionHeight) * proportionWidth) //选框的宽
        ...
        canvas.drawLine(
            rightLine - 4, bottomLine - 4, rightLine - 4, bottomLine - 40 - 4,
            linePaint!!
        )
        canvas.drawLine(
            rightLine - 4, bottomLine - 4, rightLine - 40 - 4, bottomLine - 4,
            linePaint!!
        )
        ...
        //绘制扇形
        linePaint!!.color = Color.parseColor("#57FF0000")
    ...
    private fun actionMove(touchX: Float, touchY: Float): Boolean {
        ...
        if (focus == LEFT_TOP) {
            ...
            if (rightLine - leftLine < 100) {
                ...
                topLine =
                    bottomLine - (((rightLine - leftLine) / proportionWidth) * proportionHeight)
                //重绘
                postInvalidate()
                return true
            }
            ...
            if (rightLine - leftLine < 100) {
                ...
                bottomLine =
                    topLine + (((rightLine - leftLine) / proportionWidth) * proportionHeight)
                //重绘
                postInvalidate()
                return true
            }
            ...
            if (bottomLine - topLine < 100) {
                ...
                rightLine =
                    leftLine + (((bottomLine - topLine) / proportionHeight) * proportionWidth)
                //重绘
                postInvalidate()
                return true
            }
    ...
    fun setBitmap(bitmap: Bitmap, proportionWidth: Int, proportionHeight: Int) {
        ...
        bimapHeight = bitmap.height.toFloat()
    ...
    fun getBitmap(context: Context?, minPixelWidth: Int, minPixelHeight: Int): Bitmap? {
        ...
        if (newBitmap.width < minPixelWidth || newBitmap.height < minPixelHeight) {
